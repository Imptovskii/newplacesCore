...
4. AntiPacketFly - противодействует читам которые базируются на пакетном принципе работы, в частности на полет.
...
7. AntiPacketElytraFly - Для противодействия пакетным ElytraFly из Future, Konas, KamiBlue, RusherHack
