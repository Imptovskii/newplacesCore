...
4. AntiPacketFly - противодействует читам которые базируются на пакетном принципе работы, в частности на полет. Который не может ловить NCP
5. Redstone - противодействует лаг машинам, отключая все редстоун механизмы на сервере при низком TPS сервера.
...
7. AntiPacketElytraFly - Для противодействия пакетным ElytraFly из Future, Konas, KamiBlue, RusherHack. Который не может ловить NCP
